...
<body>
    <div class="weadmin-body">
        <form class="layui-form" method="post" action="<%=request.getContextPath()%>/admin/adduser">
...
<!--               <div class="layui-form-mid layui-word-aux">
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  <input type="text" value="" id="age" name="age" required="" 
                  autocomplete="off" class="layui-input">
              </div>
              <div class="layui-form-mid layui-word-aux">
                  <span class="we-red">*</span>
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-block">
                	...
                	<input type="radio" name="userType" lay-skin="primary" value="co" title="企业" checked="">
